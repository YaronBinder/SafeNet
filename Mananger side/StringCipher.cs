...
namespace Server_manager
{
    public static class StringCipher
    {
        ...
        public static string Encrypt(string passPhrase, string plainText)
        {
            ...
            using var text = new Rfc2898DeriveBytes(plainText, saltStringBytes, DerivationIterations);
            byte[] keyBytes = text.GetBytes(Keysize / 8);
        ...
        public static string Decrypt(string cipherText, string plainText)
        {
